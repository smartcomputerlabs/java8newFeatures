...
public class PathMyFileChecker {
	public static void main(String[] args) throws IOException {
		...
		Files.walkFileTree(Paths.get("H:\\mpgsSupport\\java8\\src\\org.javacommunity.nio\\pathtest"), mfc);
		System.out.println(mfc.getCount());
		System.out.println(Paths.get("H:\\mpgsSupport\\java8\\src\\org.javacommunity.nio\\pathtest").startsWith("H:\\"));
	}
