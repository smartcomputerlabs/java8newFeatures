...
/**
 * You can modify the objects of the collection not the collection itself or you can return an updated collection using java8 org.javacommunity.stream
 * 
...
public class ModifyUnderLyingCollectionUsingStream {
	...
	public static void main(String[] args) {
		...
		// -- Modify objects of the collection using org.javacommunity.stream
		...
		System.out.println("My Shopping Cart after making changes using java8 org.javacommunity.stream");
		shoppingCartList.stream().forEach(shoppingCart -> System.out.println(shoppingCart.itemName +" - "+shoppingCart.itemQuantity));
		
		// Get a new updated collection from another collection usng org.javacommunity.stream
		...
		System.out.println("My updated Shopping Cart after making changes using java8 org.javacommunity.stream");
