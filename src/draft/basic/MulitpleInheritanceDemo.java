...
//public class MulitpleInheritanceDemo implements A1, B1 { // compilatioin error implement doStuff
//public class MulitpleInheritanceDemo implements A2, B1 { // compilatioin error implement doStuff as B1 doesn't override doStuff, but has it's pwn doStuff
...
//	public class MulitpleInheritanceDemo implements A2, B2 { // allowed doStuff from B2 invoked, as doStuff of A2 is overridden in B2
	public class MulitpleInheritanceDemo implements A3 { // compilatioin error implement doStuff
